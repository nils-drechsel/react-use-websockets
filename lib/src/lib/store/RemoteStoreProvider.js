...
const RemoteStoreProvider = ({ id, children, showElementWhileConnecting }) => {
    const remoteStoreMap = (0, react_1.useContext)(RemoteStoreContext_1.default);
    const { manager } = (0, useWebSocket_1.useWebSocket)(id);
    const [store, setStore] = (0, react_1.useState)(null);
    (0, react_1.useEffect)(() => {
        const store = new RemoteStore_1.RemoteStore(manager);
        setStore(store);
        return () => {
