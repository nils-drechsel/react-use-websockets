...
exports.WebSocketProvider = ({ url, messageIdent, payloadIdent, children }) => {
    const managerRef = react_1.useRef();
    if (!managerRef.current) {
        managerRef.current = new WebSocketManager_1.WebSocketManager(url, messageIdent || "message", payloadIdent || "payload");
    }
