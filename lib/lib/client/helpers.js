...
exports.useListenEffect = (id, message, callback, onInit) => {
...
exports.useServerValidationEffect = (id, componentId, setValidation, onSuccess, onFailure, onInit) => {
...
exports.useServerValidation = (id, componentId, setValidation) => {
    const { listen } = useWebSocket_1.useWebSocket(id);
