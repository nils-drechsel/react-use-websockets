...
class WebSocketManager {
    ...
    onConnect(_event) {
        ...
        this.send(Beans_1.CoreMessage.SID);
        ...
        callbacks === null || callbacks === void 0 ? void 0 : callbacks.forEach(callback => callback ? callback(this.isConnected(), this.isReady(), this.sid) : null);
    }
    facilitateConnect() {
        if (this.logging)
            console.log("connection established with sid ", this.sid);
        const callbacks = Array.from(this.connectivityListeners.values()).map((listener) => this.connectivityListenerToCallback.get(listener));
        callbacks === null || callbacks === void 0 ? void 0 : callbacks.forEach(callback => callback ? callback(this.isConnected(), this.isReady(), this.sid) : null);
        this.resolveQueue();
    }
    onClose(event) {
        ...
        const callbacks = Array.from(this.connectivityListeners.values()).map((listener) => this.connectivityListenerToCallback.get(listener));
        callbacks === null || callbacks === void 0 ? void 0 : callbacks.forEach(callback => callback ? callback(this.isConnected(), this.isReady(), null) : null);
    ...
    onMessage(event) {
        ...
        if (message === Beans_1.CoreMessage.SID) {
            this.sid = payload;
