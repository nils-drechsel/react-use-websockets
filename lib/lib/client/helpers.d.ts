...
export declare const useServerValidationEffect: <VALIDATION_TYPE extends ValidationBean>(componentId: string, setValidation: Dispatch<SetStateAction<VALIDATION_TYPE>>, onSuccess?: ((validation: VALIDATION_TYPE) => void) | undefined, onFailure?: ((validation: VALIDATION_TYPE) => void) | undefined, onInit?: (() => void) | undefined) => void;
export declare const useServerValidation: <VALIDATION_TYPE extends ValidationBean>(componentId: string, setValidation: Dispatch<SetStateAction<VALIDATION_TYPE>>) => (onSuccess?: ((validation: VALIDATION_TYPE) => void) | undefined, onFailure?: ((validation: VALIDATION_TYPE) => void) | undefined) => UnsubscribeCallback;
