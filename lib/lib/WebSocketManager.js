...
class WebSocketManager {
    ...
    onConnect(_event) {
        ...
        callbacks === null || callbacks === void 0 ? void 0 : callbacks.forEach(callback => callback(true));
        this.resolveQueue();
    }
    onClose(event) {
        console.log("close connection", event);
        const callbacks = Array.from(this.connectivityListeners.values()).map((listener) => this.listenerToCallback.get(listener));
        callbacks === null || callbacks === void 0 ? void 0 : callbacks.forEach(callback => callback(false));
