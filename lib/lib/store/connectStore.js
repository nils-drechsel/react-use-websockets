...
const connectStore = (useMapStores, showElementWhileConnecting, showElementOnError) => (WrappedComponent) => {
    return (props) => {
        ...
        if (storeMetas.some(meta => meta.state === RemoteStore_1.StoreConnectionState.ERROR || (meta.state === RemoteStore_1.StoreConnectionState.ACCESS_DENIED && !meta.optional))) {
            ...
            console.error("errors in connect store:", errors);
        ...
        console.log("all props", WrappedComponent, props, newProps);
        return react_1.default.createElement("div", null,
            react_1.default.createElement("span", null, "rendering wrapped component"),
            react_1.default.createElement("span", null, JSON.stringify(newProps)),
            react_1.default.createElement(WrappedComponent, { ...props, ...newProps }));
    };
};
