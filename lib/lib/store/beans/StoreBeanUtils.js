...
exports.createStoreId = (path, params) => {
    path = [...path];
...
exports.errorNotEmpty = (fieldName, errorMessage) => {
    if (errorMessage)
        return errorMessage;
...
exports.errorComparison = (cmp, baseValue, fieldName, errorMessage) => {
    if (errorMessage)
        return errorMessage;
    switch (cmp) {
        case Beans_1.Comparator.EQUAL:
...
exports.errorRegex = (fieldName, errorMessage) => {
    if (errorMessage)
        return errorMessage;
...
exports.errorLength = (length, fieldName, errorMessage) => {
    if (errorMessage)
        return errorMessage;
...
exports.errorSize = (size, fieldName, errorMessage) => {
    if (errorMessage)
        return errorMessage;
