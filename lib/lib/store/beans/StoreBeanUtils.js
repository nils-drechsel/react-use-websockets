...
const updatePartialBean = (setBean, remoteStore, debounceTime) => {
    const remoteStoreFunction = debounceTime ? (0, debounce_1.default)(remoteStore, debounceTime) : remoteStore;
...
const validatePassword = (pw, minEntropy, partial) => {
    ...
    if (!pw)
        return false;
    return (0, ClientUtils_1.passwordConformsToEntropy)(pw, minEntropy);
};
...
var TimeoutCallbackState;
(function (TimeoutCallbackState) {
    TimeoutCallbackState[TimeoutCallbackState["NORMAL"] = 0] = "NORMAL";
    TimeoutCallbackState[TimeoutCallbackState["TIMEOUT"] = 1] = "TIMEOUT";
})(TimeoutCallbackState || (exports.TimeoutCallbackState = TimeoutCallbackState = {}));
const callbackWithTimeout = (timeoutInSeconds, callback) => {
    let called = false;
...
const valdiationCallbackWithTimeout = (timeoutInSeconds, callback) => {
    return (0, exports.callbackWithTimeout)(timeoutInSeconds, callback);
};
exports.valdiationCallbackWithTimeout = valdiationCallbackWithTimeout;
