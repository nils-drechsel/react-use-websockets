...
const usePartialRemoteStoreUpdate = (id, path, params, validationFunction, postServerValidationCallback, postClientValidationCallback, onInitCallback) => {
    return exports.useRemoteStoreUpdate(id, path, params, validationFunction, postServerValidationCallback, postClientValidationCallback, onInitCallback, true);
};
exports.usePartialRemoteStoreUpdate = usePartialRemoteStoreUpdate;
const useRemoteStoreUpdate = (id, path, params, validationFunction, postServerValidationCallback, postClientValidationCallback, onInitCallback, partial) => {
