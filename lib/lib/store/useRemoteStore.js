...
exports.useRemoteStore = (id, path, params, callback, dependency) => {
...
exports.useRemoteSingleStore = (id, path, params, updateDependent, dependency) => {
...
exports.useRemoteStoreArray = (id, path, params, dependency) => {
