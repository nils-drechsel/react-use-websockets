...
const useRemoteStoreArray = (id, primaryPath, secondaryPath, params, callback, dependency, connectionMetaRef, setConnectionMeta) => {
    const res = (0, exports.useRemoteStore)(id, primaryPath, secondaryPath, params, callback, dependency, connectionMetaRef, setConnectionMeta);
    return {
