...
const RemoteStoreProvider = ({ id, children, serialisationSignatures, serialisationPairs, deserialisationPairs, }) => {
    ...
    react_1.useEffect(() => {
        const store = new RemoteStore_1.RemoteStore(manager, serialisationSignatures, serialisationPairs, deserialisationPairs);
        setStore(store);
        return () => {
