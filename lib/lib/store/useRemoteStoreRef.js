...
exports.useRemoteStoreRef = (id, path, params, callback, dependency, connectionStateRef, setConnectionState) => {
...
exports.useRemoteSingleStoreRef = (id, path, params, updateDependent, dependency, connectionStateRef, setConnectionState) => {
...
exports.useRemoteStoreArrayRef = (id, path, params, dependency, connectionStateRef, setConnectionState) => {
