...
export declare const connectStore: <MappedProps, OwnProps>(useMapStores: (ownProps: OwnProps, connectionStateRef: ConnectionStateRef, setConnectionState: React.Dispatch<React.SetStateAction<ConnectionState>>) => MappedProps) => <C extends React.ComponentType<Matching<MappedProps, GetProps<C>>>>(WrappedComponent: C) => React.ComponentType<JSX.LibraryManagedAttributes<C, Pick<GetProps<C>, Exclude<keyof GetProps<C>, keyof MappedProps>>>>;
