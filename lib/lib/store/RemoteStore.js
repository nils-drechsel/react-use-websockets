...
class RemoteStore {
    ...
    initRemoteStore() {
        return [this.websocketManager.addListener(Beans_1.CoreMessage.STORE_UPDATE, (payload, fromSid) => {
                this.update(payload.id, payload.payload);
            }),
            this.websocketManager.addListener(Beans_1.CoreMessage.STORE_DISCONNECT, (payload, fromSid) => {
